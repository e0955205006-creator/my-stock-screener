...
def main():
        ...
        try:
            ...
            if is_hold or abs(diff) <= 0.01:
                ...
                <div class="card mb-4 shadow border-0">
                    ...
                    <div class="card-body">
                        <p class="mb-2"><b>{ma_len}MA 偏離:</b> <span class="{"text-danger" if diff < 0 else "text-success"}" style="font-weight:bold;">{diff*100:+.2f}%</span> | <b>價格:</b> ${price:.2f}</p>
    ...
    with open("index.html", "w", encoding="utf-8") as f:
        f.write(f'''
        <!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>美股監控</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"></head>
        <body class="bg-light py-5"><div class="container" style="max-width:800px;">
            <div class="text-center mb-5">
                <h2 class="fw-bold">🎯 美股雲端連動儀表板</h2>
                <p class="text-muted">最後更新: {today_str} (台北)</p>
            </div>
            {results_html if results_html else '<p class="text-center">目前無符合條件股票</p>'}
        </div></body></html>''')
